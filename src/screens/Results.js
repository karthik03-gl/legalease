  ...
  return (
    <div className="screen results-screen">
      ...
      <TopBar
        ...
        onBack={onBack}
        right={
          <button style={{ width:36, height:36, borderRadius:10, background: saved ? '#ECFDF5' : 'white', border:`1px solid ${saved ? '#10B981' : '#E2E8F0'}`, display:'flex', alignItems:'center', justifyContent:'center', cursor:'pointer', transition:'all 0.2s' }}
        ...
        {translating ? (
          ...
          <>
            ...
            <div className="results-actions">
              <button className="btn btn-outline" onClick={() => setSaved(s => !s)}>
                <Icon name="save" size={15} color={saved ? '#10B981' : '#64748B'} />
